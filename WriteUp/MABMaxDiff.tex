...
\begin{algorithm}
\label{Adaptive MaxDiff}
\begin{algorithmic}[1]
\State Initialize first set of questions by sampling $L$ items uniformly
\State Design MaxDiff questionnaire to next respondent $J$ tasks of  question =MDDesign($L,S$)
\State Collect new data from respondents
\State Bayesian Bootstrap sample of data
\State Estimate model parameters

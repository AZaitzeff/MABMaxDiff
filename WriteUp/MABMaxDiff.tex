...
\begin{figure}%
    \caption{Top k={3,10} Hit Rates for with 120 items}%
    \label{fig:example}%
    \centering
...
\eric{For tables, reorder columns: fixed\_express, greedy, greedy\_thres, TS, TSed, TS\_thres, TSed}

\begin{table}
\caption{Top k Hit Rate for Various Algorithms at the {260th, 500th} Respondent with 120 Items}
\label{table:example}
\begin{center}
\begin{tabular}{llllllllll}
\hline   k &  fixed\_express &  greedy &  greedythres &  mismin &    TS &  TSe4 &  TSregthres &  TSthres &  uncert \\ \hline
  3 &          0.650 &   0.853 &        0.860 &   0.883 & 0.863 & 0.873 &       0.850 &    \textbf{0.893} &   0.840 \\
  10 &          0.825 &   0.880 &        0.902 &   0.907 & \textbf{0.923} & 0.909 &       0.909 &    0.907 &   0.901 \\
  20 &          0.824 &   0.784 &        0.863 &   0.885 & 0.825 & 0.820 &       0.869 &    0.879 &   \textbf{0.886} \\  
  40 &          0.857 &   NA &        0.884 &   \textbf{0.908} & NA & NA &       0.895 &    0.888 &   0.897\end{tabular}
\begin{tabular}{llllllllll}
\hline   
...
\hline
  ...
  40 &          0.887 &   NA &        0.926 &   0.937 & NA & NA &       0.929 &    0.927 &   \textbf{0.938} \end{tabular}
\end{center}
\end{table}

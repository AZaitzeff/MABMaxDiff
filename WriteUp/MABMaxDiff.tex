...
\subsection{Compared to Multi-Armed Bandit}
\textbf{Multi-armed bandit, best-arm identification, and active learning}
...
\subsubsection{Standard bandit problem}

Continuing the above notation, we define Thompson Sampling. 

\subsubsection{best-arm identification}

The best arm identification problem...
More generally, selecting the best $k$ instead of single best, is known as the best-k-arms identification problem...
...
To illustrate the growing interest in MaxDiff, Sawtooth Software's Customer Feedback Survey, representing users of the software, reveals the extent of the increasing penetration and need to accommodate more items. By 2017, nearly 70\% of users had employed some MaxDiff study. The survey also asked for the largest number of items that users had included in a MaxDiff study during the last 12 months (Figure \ref{fig:max_and_purpose}). Nearly 20\% of respondents indicated their firms had conducted a study with 51 or more items, and the maximum was 400. 
...
Our research shows that if this is the main goal, then traditional design strategies can be wasteful. We will show that an adaptive approach using bandit algorithms can be up to 4x more efficient-- without the Bandit Adaptive Maxdiff approach, you are potentially wasting 75 cents of every dollar you are spending on MaxDiff data collection. 


\subsection{MaxDiff choice model}
Consider describing the choice model and basic data collection for standard static fixed maxdiff. 

...
We used two hit rate measures.\\ \textbf{Top k hit rate}: what percent of the top k true items the estimated scores using robotic respondents identified. For instance, if k is 10 and if the estimated scores identified 7 of the true top 10 items (irrespective of order), the hit rate was 70\%
...
\end{center}
\caption{Top k Hit Rate for Various Algorithms at the 260th Respondant for the 300 item data set}
...
\end{center}
\caption{Top k Hit Rate for Various Algorithms at the 500th Respondant for the 300 item data set}
